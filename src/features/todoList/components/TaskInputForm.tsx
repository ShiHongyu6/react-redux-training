...
export default class TaskInputForm extends React.Component<ITaskInputFormProps, ITaskInputFormState> {
...
function parseDateTimeStringToDate(dateString:string, timeString:string) {
  ...
  const [hour, minute] = timeString.split(':').map(str => Number(str));
